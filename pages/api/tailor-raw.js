...
export default async function handler(req, res) {
  ...
  try {
    ...
    // AI Call (passing empty array for currentSkills since we don't parse structured skills from raw PDF)
    const suggestions = await tailorResumeForJD(resumeText, jobDescription, []);
    ...
    console.error('[Tailor Raw API Error]', error);
